...
> A `Coupling.Gear` constrains the **ratio** and cares nothing about whether a
> tooth was ever drawn — the cylinders below carry no teeth at all. For the tooth
> **forms** — involute, helical, herringbone, rack, worm, bevel, planetary,
> cycloidal — and the geometry that generates them, see [Gears](gears.md).
