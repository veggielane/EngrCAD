...
public sealed class PdfDrawing
{
    ...
    private static Encoded EncodeWinAnsi(string source)
    {
        // The drafting symbols WinAnsi cannot spell become their ASME Y14.5 word forms
        // HERE and not on the embedded path: an embedded font may genuinely carry U+21A7,
        // and spelling it "DEEP" there would replace a correct glyph with a workaround.
