...
MID/LDS 3D routing and the richer interchange (KiCad `.kicad_pcb`, STEP AP214 board assemblies) —
each a later stage over this one graph. On the LIBRARY side, **Eagle `.lbr`** (an XML second reader), **IPC-7351 footprint
