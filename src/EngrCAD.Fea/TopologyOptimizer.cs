...
/// <item><b>Several load cases</b> — the objective is then a WEIGHTED sum and the weighting is
/// the design decision, not something a library picks. Hence one <see cref="StructuralModel"/>
/// per call, and no list overload that would have to invent one.</item>
/// </list></para>
/// </summary>
